...
// https://api.iconify.design/mdi.js?icons=arrow-left,arrow-right,brightness-4,brightness-7,chevron-left,chevron-right,close,github,search,star&pretty=1&callback=addCollection
addCollection({
  prefix: 'mdi',
  icons: {
    'arrow-left': {
