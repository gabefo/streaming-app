...
// https://api.iconify.design/mdi.js?icons=arrow-left,arrow-right,check,chevron-left,chevron-right,close,github,linkedin,menu-down,menu-up,search,star,web&pretty=1&callback=addCollection
addCollection({
  prefix: 'mdi',
  icons: {
    'arrow-left': {
